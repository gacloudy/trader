...
public interface StockDateAvgRepository extends JpaRepository<StockDateAvg, StockDateAvgPK> {
	...
	List<StockDateAvg> findByCodeAndSpanAndPriceDateBetween(@Param("code") int code, @Param("span") int span, @Param("date_from")  String dateFrom, @Param("date_to")  String dateTo);
